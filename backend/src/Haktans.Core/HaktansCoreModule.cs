...
namespace Haktans
{
    public class HaktansCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            Configuration.DefaultNameOrConnectionString = string.IsNullOrEmpty(envConnStr)
                ? HaktansConsts.ConnectionStringName
                : envConnStr;
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(HaktansCoreModule).GetAssembly());
        }
    }
}
