...
namespace Haktans.Authorization
{
    public class HaktansAuthorizationProvider : AuthorizationProvider
    {
        ...
        {
            return new LocalizableString(name, HaktansConsts.LocalizationSourceName);
        }
    }
}
