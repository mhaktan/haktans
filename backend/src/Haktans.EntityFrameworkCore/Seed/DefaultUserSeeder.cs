...
using Haktans.Authorization;
using Haktans.Entities;

namespace Haktans.EntityFrameworkCore.Seed
{
    /// <summary>
    ...
    public class DefaultUserSeeder
    {
        ...
        public void Seed()
        {
            ...
            try
            {
                ...
                {
                    customRole_0 = new AppRole { Name = "LineMechanic", DisplayName = "Line Mechanic", Description = "Hat bakım teknisyeni — snag raporlarını görür, üstlenip işlem yapar ve CRS onayına iletir.", IsSystem = false, IsActive = true };
                ...
                var customPerms_0 = new[] { "SnagReport.Read", "SnagReport.Create", "SnagReport.Update", "SnagReport.ChangeStatus", "Aircraft.Read" };
                ...
                {
                    customRole_1 = new AppRole { Name = "CertifyingStaff", DisplayName = "Certifying Staff", Description = "Sertifikalandırma personeli — tamamlanan işlemleri denetler, CRS numarası girerek sertifikayı düzenler, kaydı kapatır veya revize için geri gönderir.", IsSystem = false, IsActive = true };
                ...
                var customPerms_1 = new[] { "SnagReport.Read", "SnagReport.Create", "SnagReport.Update", "SnagReport.Delete", "SnagReport.ChangeStatus", "Aircraft.Read", "Aircraft.ChangeStatus" };
