...
{
    [DependsOn(typeof(HaktansCoreModule), typeof(AbpEntityFrameworkCoreModule))]
    public class HaktansEntityFrameworkCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            Configuration.Modules.AbpEfCore().AddDbContext<HaktansDbContext>(options =>
            {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(HaktansEntityFrameworkCoreModule).GetAssembly());
        }
    }
}
