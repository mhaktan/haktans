                ...
                switch (node.Type)
                {
                    ...
                    case "approval":
                        ...
                        try
                        {
                            ...
                            var appServiceType = Type.GetType("Haktans.Approvals.IApprovalAppService, Haktans.Application")
                                ?? throw new InvalidOperationException("IApprovalAppService type not found in Haktans.Application assembly");
                            ...
                            var submitInputType = Type.GetType("Haktans.Approvals.Dto.SubmitApprovalInput, Haktans.Application")!;
